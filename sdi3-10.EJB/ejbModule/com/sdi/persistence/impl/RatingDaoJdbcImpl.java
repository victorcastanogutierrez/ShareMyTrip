...
public class RatingDaoJdbcImpl implements RatingDao {
	...
	@Override
	public List<Rating> findByUserAndNoTrip(Long aboutUserId) {
	...
	@Override
	public List<Rating> findAllFromUserTrip(Long userId, Long id_viaje,
			Long id_viaje2) {
		return jdbcTemplate.queryForList(
				"RATING_FIND_FROM_USER_AND_TRIP", 
				new RatingMapper(), 
				id_viaje, userId, id_viaje2
			);
	}
